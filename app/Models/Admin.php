...
final class Admin {
    ...
    private static function catalogTables(): array {
        return [
            ...
            'provider_cities'=>['name'=>'Ciudades','category'=>'Organizacional','description'=>'Ciudades usadas en contrapartes y contratos.','icon'=>'bi-geo-alt','priority'=>2],
            ...
            'provider_types'=>['name'=>'Tipos de contraparte','category'=>'Directorio','description'=>'Persona natural o juridica de la contraparte.','icon'=>'bi-person-badge','priority'=>1],
            'catalog_tipo_contratista'=>['name'=>'Tipo contratista','category'=>'Directorio','description'=>'Contratista, consorcio, union temporal y demas tipos legales.','icon'=>'bi-diagram-3','priority'=>2],
            'catalog_tipo_persona'=>['name'=>'Tipo persona','category'=>'Directorio','description'=>'Persona natural, juridica o juridica extranjera.','icon'=>'bi-person-vcard','priority'=>3],
            'catalog_naturaleza'=>['name'=>'Naturaleza','category'=>'Directorio','description'=>'Naturaleza privada, publica o sin animo de lucro.','icon'=>'bi-bank','priority'=>4],
            'catalog_clasificacion'=>['name'=>'Clasificacion','category'=>'Directorio','description'=>'Clasificacion legal de la contraparte.','icon'=>'bi-tags','priority'=>5],
            'catalog_nacionalidad_contratista'=>['name'=>'Nacionalidad del contratista','category'=>'Directorio','description'=>'Nacional o extranjero.','icon'=>'bi-globe-americas','priority'=>6],
            'catalog_clase_contratista'=>['name'=>'Clase contratista','category'=>'Directorio','description'=>'Clase del contratista dentro del proceso.','icon'=>'bi-shield-check','priority'=>7],
            'contract_supervisors'=>['name'=>'Supervisores','category'=>'Directorio','description'=>'Supervisores responsables del seguimiento.','icon'=>'bi-person-check','priority'=>8],
