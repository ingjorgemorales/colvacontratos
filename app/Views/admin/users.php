...
<section class="admin-screen-modern">
  <section class="admin-card">
    <div class="form-section-head"><i class="bi bi-person-plus"></i><div><h2>Crear usuario</h2><p>La clave inicial se genera automaticamente y se envia al correo registrado.</p></div></div>
